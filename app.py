    ...
    for field_name, config in form_config.items():
        ...
        try:
            ...
            if field_type == "select":
                ...
                st_date_value = date_value if date_value is not None else date.today()
                if min_date and st_date_value < min_date:
...
BOTONES_COPIADO_POR_HOJA = {
    "DOTACION": { "Copiar Apellido": "APELLIDOS", "Copiar Nombre": "NOMBRES", "Copiar Grado": "GRADO" },
    "LICENCIAS": { "Copiar Expediente": "EXPEDIENTE", "Copiar Nombre y Apellido": "NOMBRE Y APELLIDO", "Copiar Días": "DIAS" },
    "IMPUNTUALIDADES": {"Copiar Expediente": "EXPEDIENTE", "SITUACION DE REVISTA IMPUNTUALIDAD": "SITUACION DE REVISTA IMPUNTUALIDAD", "ORDENATIVA DE IMPUNTUALIDAD": "ORDENATIVA DE IMPUNTUALIDAD", "ARCHIVO DE IMPUNTUALIDAD": "ARCHIVO DE IMPUNTUALIDAD"},
    "FUNCIONES": { "EXPEDIENTE": "EXPEDIENTE", "Grado": "GRADO", "ORDENATIVA": "ORDENATIVA", "ARTICULO": "ARTICULO", "ELEVACION": "ELEVACION", "ARCHIVO": "ARCHIVO", "ANOTACION D.L.P." : "ANOTACION D.L.P."},
